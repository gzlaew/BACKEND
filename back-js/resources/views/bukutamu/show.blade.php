    ...
    <div class="border-b border-gray-900/10 pb-12">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                    <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-200">Name</th>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        {{ $users->name ?? 'Data not provided' }}
                    </td>
                </tr>
                <tr>
                    <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-200">Email</th>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        {{ $users->email ?? 'Data not provided' }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        <div class="max-w-xs">
                            <img src="{{ asset('uploads/'.$users->foto)}}" alt="">
                        </div>
                    </td>
                </tr>
                <tr>
                    <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-200">Role</th>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        @if ($users->type === '1')
                            Admin
                        @elseif ($users->type === '2')
                ...
                <tr>
                    <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-200">Address</th>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        {{ $users->alamat ?? 'Data not provided' }}
                    </td>
                </tr>
                <tr>
                    <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-200">Gender</th>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        {{ $users->gender ?? 'Data not provided' }}
                    </td>
                </tr>
                <tr>
                    <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-200">Phone Number</th>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200">
                        {{ $users->nohp ?? 'Data not provided' }}
                    </td>
                </tr>
            </tbody>
        </table>
